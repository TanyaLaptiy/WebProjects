...
async function confirmFunc(number){
...
function makeMove(number) {
    ...
    setTimeout(confirmFunc, 800,number);
...
function checkAvailableJumpSpaces() {
    ...
    if (turn) {
        ...
        if (board[selectedPiece.indexOfBoardPiece - 21] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 14] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 7] >= 12 || board[selectedPiece.indexOfBoardPiece - 14] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 28] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 21] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 7] >= 12 || board[selectedPiece.indexOfBoardPiece - 14] >= 12 || board[selectedPiece.indexOfBoardPiece - 21] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 35] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 28] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 7] >= 12 || board[selectedPiece.indexOfBoardPiece - 14] >= 12 || board[selectedPiece.indexOfBoardPiece - 21] >= 12 || board[selectedPiece.indexOfBoardPiece - 28] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 42] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 35] >= 12 && 
        ...
        if (board[selectedPiece.indexOfBoardPiece - 49] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 42] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 7] >= 12 || board[selectedPiece.indexOfBoardPiece - 14] >= 12 || board[selectedPiece.indexOfBoardPiece - 21] >= 12 || board[selectedPiece.indexOfBoardPiece - 28] >= 12 || board[selectedPiece.indexOfBoardPiece - 35] >= 12 || board[selectedPiece.indexOfBoardPiece - 42] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 27] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 18] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 9] >= 12 || board[selectedPiece.indexOfBoardPiece - 18] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 36] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 27] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 9] >= 12 || board[selectedPiece.indexOfBoardPiece - 18]>= 12 || board[selectedPiece.indexOfBoardPiece - 27] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 45] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 36] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 9] >= 12 || board[selectedPiece.indexOfBoardPiece - 18] >= 12 || board[selectedPiece.indexOfBoardPiece - 27]>= 12 || board[selectedPiece.indexOfBoardPiece - 36] >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 54] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 45] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 9]  >= 12 || board[selectedPiece.indexOfBoardPiece - 18]  >= 12 || board[selectedPiece.indexOfBoardPiece - 27]  >= 12 || board[selectedPiece.indexOfBoardPiece - 36] >= 12 || board[selectedPiece.indexOfBoardPiece - 45]  >= 12)&&
        ...
        if (board[selectedPiece.indexOfBoardPiece - 63] === null
            ...
            && board[selectedPiece.indexOfBoardPiece - 54] >= 12 && 
            (board[selectedPiece.indexOfBoardPiece - 9] >= 12 || board[selectedPiece.indexOfBoardPiece - 18] >= 12|| board[selectedPiece.indexOfBoardPiece - 27] >= 12 || board[selectedPiece.indexOfBoardPiece - 36] >= 12 || board[selectedPiece.indexOfBoardPiece - 45] >= 12 || board[selectedPiece.indexOfBoardPiece - 54] >= 12)&&
